package com.raycloud.module.util.qiniu;
...
import com.raycloud.module.util.ContentTypeUtil;
...
public class QiniuUtils {
    ...
    public static String getPreFileNameByDate(){
        return simpleDateFormat.format(new Date())+"_"+(count++ % MOD);
    }
    ...
    public String uploadPic(MultipartFile pic)throws Exception{
        ...
        QiniuUtils.getInstance().upload(fileName.toString(),savePath.toString());
